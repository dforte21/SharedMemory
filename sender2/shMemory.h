 ...
 *
 *****************************************************************************/
__declspec(dllimport) unsigned char *__stdcall MFShMemGetPointer(void);
 ...
 *
 *****************************************************************************/
__declspec(dllimport) void  __stdcall MFShMemRead (unsigned char *destBuffer, const unsigned int startOffset, 
 ...
 *
 *****************************************************************************/
__declspec(dllimport) void  __stdcall MFShMemWrite(const unsigned char *sourceBuffer, const unsigned int startOffset, 
                                                const unsigned int numOfBytes);
 ...
 *
 *****************************************************************************/
__declspec(dllimport) char  __stdcall MFShMemSend (const unsigned int startOffset, const unsigned int numOfBytes);
 ...
 *
 *****************************************************************************/
__declspec(dllimport) unsigned char __stdcall MFShMemDisableComm(void);
